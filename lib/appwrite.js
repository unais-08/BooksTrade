...
export const getConnectedUsers = async (userId) => {
  try {
    ...
    // Log the contents of usersSet to ensure users are being added
    // console.log("Users Set:", Array.from(usersSet));
...
export const getUsersByIds = async (userIds) => {
  try {
    ...
    // console.log("Fetched Users:", validUsers); // Log the fetched user details
    return validUsers;
  } catch (error) {
