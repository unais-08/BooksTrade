...
// export const handleUpdateStatus = async (documentId, newStatus) => {
//   try {
//     // Update the trade request's status in the Appwrite database
//     const response = await databases.updateDocument(
//       config.databaseId, // Database ID
//       config.tradeCollectionId, // Trade collection ID
//       documentId, // Document ID of the trade request
//       {
//         status: newStatus, // New status: 'Accepted' or 'Rejected'
//       }
//     );
